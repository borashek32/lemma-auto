                    ...
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                               leading-tight focus:outline-none focus:shadow-outline @error('payment_method') border-red-500 @enderror"
                               id="exampleFormControlInput2" placeholder="Введите название" wire:model="payment_method">
                            @error('peyment_method') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="">
                            <div class="mb-4">
                                <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">
                                ...
                                <textarea type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                                   ...
                                   id="exampleFormControlInput2" placeholder="Введите описание" wire:model="description" rows="10"></textarea>
