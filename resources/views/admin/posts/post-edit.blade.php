            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            @include('admin.posts.img-uploader')
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-2" wire:ignore id="post.page_text">
                                <div
                                    wire:key="uniqueKey"
                                    wire:model.debounce.365ms="post.page_text"
                                    x-data
                                    @trix-blur="$dispatch('input', $event.target.value)"
                                >
                                    <input id="x" type="hidden" value="{!! $post->page_text !!}">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                              <button wire:click.prevent="save()" type="button" class="inline-flex justify-center w-full
