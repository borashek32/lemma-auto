...
<div class="py-5">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <h1>Форма редактирования постов</h1>
        <div>
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    <div class="col-span-3 sm:col-span-2">
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <textarea required id="title" type="text" name="title" class="form-input
                                                                @error('title') is-invalid @enderror
                                                flex-1 block w-full rounded-none rounded-md transition duration-150 ease-in-out
                                                sm:text-sm sm:leading-5" rows="1" minlength="3">{{ $post->title }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-6">
                                    ...
                                    <div class="rounded-md shadow-sm">
                                        ...
                                        @error('text') is-invalid @enderror
                                            mt-1 block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                                  minlength="10">{{ $post->text }}</textarea>
                                    </div>
                                </div>
                            </div>
