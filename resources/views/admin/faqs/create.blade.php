            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                <form action="{{ route('faqs.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" value="{{ old('question') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                            leading-tight focus:outline-none focus:shadow-outline @error('title') border-red-500
                            @enderror" id="exampleFormControlInput2" name="question" required>
