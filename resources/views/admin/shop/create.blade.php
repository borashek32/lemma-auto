        ...
        transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true"
            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        <p style="margin-bottom: 10px">Новыая автозапчасть</p>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                            leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput2"
                                   placeholder="Введите название" wire:model="number">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                            leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput2"
                                   placeholder="Введите название" wire:model="price">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                            leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput2"
                                   placeholder="Введите название" wire:model="delivery_time">
                            @error('delivery_time') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
