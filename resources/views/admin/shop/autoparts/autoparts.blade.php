        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            <div class="flex md:flex-row w-full">
                <div class="w-full md:w-3/10 text-left">
                    ...
                    @if($isOpen)
                        @include('admin.shop.autoparts.create')
                    @endif
                </div>
            ...
            <table class="table-fixed w-full">
                ...
                <tr class="bg-gray-100">
                    ...
                    <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider">Каталожный номер</th>
                ...
                @foreach($autoparts as $autopart)
                    <tr>
                        ...
                        <td class="px-6 py-4 border-b border-gray-300 text-sm leading-5">{{ $autopart->section->name }}</td>
