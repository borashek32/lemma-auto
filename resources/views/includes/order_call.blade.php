<div class="spacePromo">
    <button type="button" style="height:50px;width:50px;" class="btn btn-outline-dark" data-toggle="modal" data-target="#call">
        <div class="row">
    ...
    <button type="button" style="height:50px;margin-left:14px;margin-right:20px;width:50px;" class="btn btn-outline-dark">
        <div class="row">
