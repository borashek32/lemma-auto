...
(function(root, factory) {
	...
	elFinder.prototype.i18.el = {
		...
		messages   : {
			...
			'errConnect'           : 'Δεν ήταν δυνατή η σύνδεση με το admin.',
			'errAbort'             : 'Η σύνδεση εγκαταλείφθηκε.',
			'errTimeout'           : 'Η σύνδεση έληξε.',
			'errNotFound'          : 'Δε βρέθηκε το admin.',
			'errResponse'          : 'Μή έγκυρη απάντηση από το admin.',
			'errConf'              : 'Μη έγκυρες ρυθμίσεις για το admin.',
			...
			'errCmdNoSupport'      : 'Το admin δεν υποστηρίζει αυτή την εντολή.',
