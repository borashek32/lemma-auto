...
(function(root, factory) {
	...
	elFinder.prototype.i18.it = {
		...
		messages   : {
			...
			'errConnect'           : 'Impossibile collegarsi al admin.',
			'errAbort'             : 'Connessione annullata.',
			'errTimeout'           : 'Timeout di connessione.',
			'errNotFound'          : 'Backend non trovato.',
			'errResponse'          : 'Risposta non valida dal admin.',
			'errConf'              : 'Configurazione admin non valida.',
			...
			'errCmdReq'            : 'La richiesta al admin richiede il nome del comando.',
