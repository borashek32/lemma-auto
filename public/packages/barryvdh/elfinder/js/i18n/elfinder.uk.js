...
(function(root, factory) {
	...
	elFinder.prototype.i18.uk = {
		...
		messages   : {
			...
			'errConnect'           : 'Не вдалося з’єднатися з admin.',
			'errAbort'             : 'З’єднання розірване.',
			'errTimeout'           : 'Тайм-аут з’єднання.',
			'errNotFound'          : 'Не знайдено admin.',
			'errResponse'          : 'Неправильна відповідь від admin.',
			'errConf'              : 'Неправильне налаштування admin.',
