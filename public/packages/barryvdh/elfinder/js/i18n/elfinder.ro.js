...
(function(root, factory) {
	...
	elFinder.prototype.i18.ro = {
		...
		messages   : {
			...
			'errConnect'           : 'Nu ne-am putut conecta la admin.',
			'errAbort'             : 'Conexiunea a fost oprită.',
			'errTimeout'           : 'Conexiunea a fost întreruptă.',
			'errNotFound'          : 'Nu am gasit admin-ul.',
			'errResponse'          : 'Răspuns admin greșit.',
			'errConf'              : 'Configurație admin greșită.',
			...
			'errCmdReq'            : 'Cererea către admin necesită un nume de comandă.',
