...
(function(root, factory) {
	...
	elFinder.prototype.i18.es = {
		...
		messages   : {
			...
			'errConnect'           : 'No se ha podido conectar con el admin.',
			'errAbort'             : 'Conexión cancelada.',
			'errTimeout'           : 'Conexión cancelada por timeout.',
			'errNotFound'          : 'Backend no encontrado.',
			'errResponse'          : 'Respuesta no válida del admin.',
			'errConf'              : 'Configuración no válida del admin .',
			...
			'errCmdReq'            : 'La petición del admin necesita un nombre de comando.',
			...
			'errCmdNoSupport'      : 'El admin no soporta este comando.',
